        ...
        <div className="mx-auto flex w-full max-w-[1440px] flex-col items-start justify-center">
          <h1 className="max-w-[720px] text-[2.25rem] font-normal leading-[1.08] tracking-[-0.035em] text-white drop-shadow-[0_2px_16px_rgba(0,0,0,0.45)] lg:max-w-[900px] lg:text-[2.75rem] lg:leading-[1.18]">
            ...
            <a
              ...
              className="absolute bottom-16 right-5 hidden size-[60px] items-center justify-center rounded-full bg-[#00d318] text-white shadow-[0_10px_28px_rgba(0,0,0,0.28)] lg:flex"
            >
              <svg
                aria-hidden="true"
                viewBox="0 0 32 32"
      ...
      >
        <div className="mx-auto grid max-w-[1440px] gap-14 lg:grid-cols-2 lg:items-center lg:gap-16">
          ...
          <div className="max-w-[650px]">
            ...
            <h2 className="mt-7 text-[2.25rem] font-semibold leading-[1.02] tracking-[-0.06em] text-white lg:text-[2.75rem]">
      ...
      >
        <div className="mx-auto max-w-[1440px]">
          <div className="mx-auto max-w-[1050px] text-center">
            ...
            <h2 className="mt-7 text-[2.25rem] font-semibold leading-[1.02] tracking-[-0.065em] text-white lg:text-[2.75rem]">
      ...
      >
        <div className="mx-auto max-w-[1440px]">
          <div className="mx-auto max-w-[1040px] text-center">
            ...
            <h2 className="mt-8 text-[2.25rem] font-semibold leading-[1.06] tracking-[-0.065em] text-white lg:text-[2.75rem]">
